...
%   ultimately extracting the FWE-corrected continuous T-map (p < 0.05). Finally, 
...
[tpmFweMap, tpmThresh] = vbmModel.getCorrectedMap(vbmDir, contrastName, pValue, correctionMode);
...
renderer.plotStatisticalOverlay(tpmFweMap, tpmThresh, CTRL117Volume, affineMat,...
        sliceConfig, contrastName, correctionMode, pValue,'TPM FWE Map', figTpmFwe);
